...
public class AddCustomer extends JInternalFrame implements ActionListener{
    ...
    public AddCustomer(JDesktopPane desk,MsAccessDatabaseConnectionInJava8 conn8) 
    {
    	super("ADD CUSTOMER", true, // resizable
					true, // closable
					true, // maximizable
					true);
    	this.desk=desk;
        ...
        p1.add(new JLabel("Customer Name:"));p1.add(t5);
    ...
    public void save()
    	{   int tempint=0;
    	    try
    	    {
    	    	st.execute("Insert Into Customer(Customer_name,Tin_no,License_no,Address) values('"+t5.getText()+"','"+t4.getText()+"','"+t2.getText()+"','"+t3.getText()+"')");
    	    }
